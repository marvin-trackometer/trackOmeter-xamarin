...
namespace trackOmeter.CustomRenderers
{
    public class CustomHorizontalListView : ScrollView
    {
        ...
        public CustomHorizontalListView()
        {
        ...
        public static readonly BindableProperty SelectedIndexProperty =
            BindableProperty.Create(nameof(SelectedIndex), typeof(int), typeof(CustomHorizontalListView), 0, BindingMode.TwoWay,
                propertyChanged: async (bindable, oldValue, newValue) =>
                {
                    await ((CustomHorizontalListView)bindable).UpdateSelectedItem();
                }
            );
        ...
        public static readonly BindableProperty ItemsSourceProperty =
            BindableProperty.Create(nameof(ItemsSource), typeof(IList), typeof(CustomHorizontalListView), null,
                propertyChanging: (bindableObject, oldValue, newValue) =>
                {
                    ((CustomHorizontalListView)bindableObject).ItemsSourceChanging();
                },
                propertyChanged: (bindableObject, oldValue, newValue) =>
                {
                    ((CustomHorizontalListView)bindableObject).ItemsSourceChanged();
                }
            );
        ...
        public static readonly BindableProperty SelectedItemProperty =
            BindableProperty.Create(nameof(SelectedItem), typeof(object), typeof(CustomHorizontalListView), null, BindingMode.TwoWay,
                propertyChanged: (bindable, oldValue, newValue) =>
                {
                    ((CustomHorizontalListView)bindable).UpdateSelectedIndex();
                }
            );
        ...
        public static readonly BindableProperty ItemWidthRequestProperty =
            BindableProperty.Create(nameof(ItemWidthRequest), typeof(Int32), typeof(CustomHorizontalListView), 100, BindingMode.TwoWay);
        ...
        public static readonly BindableProperty ItemHeightRequestProperty =
            BindableProperty.Create(nameof(ItemHeightRequest), typeof(Int32), typeof(CustomHorizontalListView), 100, BindingMode.TwoWay);
