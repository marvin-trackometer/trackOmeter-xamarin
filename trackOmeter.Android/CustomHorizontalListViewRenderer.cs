...
[assembly: ExportRenderer(typeof(CustomHorizontalListView), typeof(CustomHorizontalListViewRenderer))]
namespace trackOmeter.Droid
{
    public class CustomHorizontalListViewRenderer : ScrollViewRenderer
    {
        readonly CustomGestureListener _listener;
        readonly GestureDetector _detector;

        public CustomHorizontalListViewRenderer(Context context) : base(context)
        {
        ...
        void HandleOnSwipeLeft(object sender, EventArgs e) =>
            ((CustomHorizontalListView)Element).OnSwipeLeft();

        void HandleOnSwipeRight(object sender, EventArgs e) =>
            ((CustomHorizontalListView)Element).OnSwipeRight();
    }
